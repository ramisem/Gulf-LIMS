...
class ArchivedAuditLogMixin:
    ...
    def resource_url(self, obj):
        ...
        try:
            ...
            return format_html(
                # '<a href="{}">{} - {}</a>', link, obj.content_type, obj.object_id
                '<table><tr><td>{}</td><td>{}</td></tr></table>', obj.content_type, obj.object_id
            )

    @admin.display(description="Changes")
    def msg_short(self, obj):
        if obj.action in [ArchivedAuditLog.Action.DELETE, ArchivedAuditLog.Action.ACCESS]:
            return ""  # delete
