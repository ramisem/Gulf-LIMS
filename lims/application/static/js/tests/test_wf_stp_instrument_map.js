$(document).ready(function () {
    setTimeout(function () {
        $('select[name^="testwfstpinstrumentmap_set-"][name$="-sample_type_id"]').not('[name*="__prefix__"]').each(function () {
    ...
    function updateContainerType($sampleTypeDropDown, isPageLoad = false) {
        ...
        const $row = $sampleTypeDropDown.closest('.dynamic-testwfstpinstrumentmap_set');
    ...
    function updateStepDropdown($workflowDropdown, isPageLoad = false) {
        ...
        const $row = $workflowDropdown.closest('.dynamic-testwfstpinstrumentmap_set');
    ...
    function updateStepNoField($stepIdDropdown, isPageLoad = false) {
        ...
        const $row = $stepIdDropdown.closest('.dynamic-testwfstpinstrumentmap_set');
    ...
    $(document).on('click', '#test-workflow-step-instruments-tab .add-row a', function () {
        setTimeout(function () {
            const $lastRow = $('#test-workflow-step-instruments-tab .dynamic-testwfstpinstrumentmap_set.last-related').last();
