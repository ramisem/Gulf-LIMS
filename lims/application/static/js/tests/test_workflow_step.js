$(document).ready(function () {
    setTimeout(function () {
        $('select[name^="testworkflowstep_set-"][name$="-sample_type_id"]').not('[name*="__prefix__"]').each(function () {
    ...
    // Loop through all step dropdowns
    $('.field-workflow_step_id select').each(function () {
        const $dropdown = $(this);
    ...
    function updateContainerType($sampleTypeDropDown, isPageLoad = false) {
        ...
        const $row = $sampleTypeDropDown.closest('.dynamic-testworkflowstep_set');
    ...
    function updateStepDropdown($workflowDropdown, isPageLoad = false) {
        ...
        const $row = $workflowDropdown.closest('.dynamic-testworkflowstep_set');
    ...
    function updateStepNoField($stepIdDropdown, isPageLoad = false) {
        ...
        const $row = $stepIdDropdown.closest('.dynamic-testworkflowstep_set');
...
//            updateStepNoField($(this), true);
//        });
//        $('#test-workflow-steps-tab .field-sample_type_id select').each(function () {
//            updateContainerType($(this), true);
//        });
    });

    $(document).on('click', '#test-workflow-steps-tab .add-row a', function () {
        setTimeout(function () {
            const $lastRow = $('#test-workflow-steps-tab .dynamic-testworkflowstep_set.last-related').last();
